...
DcsBios::IntegerBuffer rolltrimindBuffer(0x44c6, 0xffff, 0, onRolltrimindChange);
DcsBios::IntegerBuffer pitchtrimindBuffer(0x44c8, 0xffff, 0, onPitchtrimindChange);
